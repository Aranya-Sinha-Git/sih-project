...
def build_source_catalogs() -> None:
    ...
    write_csv(ROOT / "01_OIL_INDIA_PUBLIC" / "oil_india_public_source_catalog.csv", [
        ...
        {"source_id":"OIL-EVENTS","title":"Public OIL incident reports","publisher":"Oil India Limited","official_url":"https://www.oil-india.com/investor-services/74","years":"2020-2024","local_path":"01_OIL_INDIA_PUBLIC/ACTUAL_EVENT_REPORTS","contains_incident_narratives":"yes","contains_statistics":"limited","priority":"1","notes":"Three distinct public event records with linked OIL and official supporting documents; reference-only and not a complete internal corpus."},
...
def write_docs(stats_count:int, profile_count:int, osha_total:int, osha_selected:int, master_records:int, narrative_records:int, bsee_records:int, dups:dict) -> None:
    ...
    reg(dataset_id="OIL-EVENT-REPORTS", dataset_name="OIL India publicly documented event reports", publisher="Oil India Limited", source_type="company incident reports", country_or_scope="India", industry="oil and gas", years_covered="2020-2024", official_landing_page="https://www.oil-india.com/investor-services/74", local_raw_path="01_OIL_INDIA_PUBLIC", file_format="PDF/HTML/JSON", file_count="7", approx_records="3", has_narrative="yes", has_outcome="yes", has_severity="yes", has_activity="yes", has_location="yes", has_causal_factors="limited", has_barrier_information="yes", has_corrective_actions="yes", recommended_use="REFERENCE_ONLY", training_allowed="no", validation_candidate="no", reference_only="yes", license_or_terms="publisher terms", quality_rating="4", priority="1", comments="Three distinct public OIL events: Baghjan Well No. 5, NHK 162 and BGN#24; source provenance is in oil_india_event_reports.json.")
