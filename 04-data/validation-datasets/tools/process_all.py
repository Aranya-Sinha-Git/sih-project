...
SOURCE_META = {
    ...
    "oil_india_nhk162_incident_2024.pdf": ("Oil India Limited", "https://www.oil-india.com/investor-services/74", "https://www.oil-india.com/files/investor_services_documents/Regthree0PressRelease15022024.pdf", "2024-02-15"),
    "oil_india_bgn24_leakage_2024.pdf": ("Oil India Limited", "https://www.oil-india.com/investor-services/74", "https://www.oil-india.com/files/investor_services_documents/Regulation%2030%20Press%20Release%2010.04.2024.pdf", "2024-04-10"),
    "oil_india_nhk67_press_release_2023_10_20.pdf": ("Oil India Limited", "https://www.oil-india.com/investor-services/74", "https://www.oil-india.com/files/investor_services_documents/Reg30PressRelease2010202third.pdf", "2023-10-20"),
    "oil_india_nhk67_press_release_2023_10_22.pdf": ("Oil India Limited", "https://www.oil-india.com/investor-services/74", "https://oilindia.php-staging.com/files/investor_services_documents/Reg30PressRelease2210202third.pdf", "2023-10-22"),
    "oil_india_nrl_fire_press_release_2023.pdf": ("Oil India Limited", "https://www.oil-india.com/investor-services/press-release-fire-incident-numaligarh-refinery-limited", "https://www.oil-india.com/files/investor_services_documents/PressReleaseonFireIncidentatNumaligarhRefineryLimited.pdf", "2023-05-29"),
    "oil_india_sustainability_report_2013_14.pdf": ("Oil India Limited", "https://www.oil-india.com/sustainability-at-oil", "https://www.oil-india.com/files/sustainability_documents/OIL_Sustainability_Report_2013_141.pdf", "2013-14"),
    "oil_india_sustainability_report_2014_15.pdf": ("Oil India Limited", "https://www.oil-india.com/sustainability-at-oil", "https://www.oil-india.com/files/sustainability_documents/OIL_Sustainability_Report_2014_151.pdf", "2014-15"),
    "dgms_oil_nhk040_safety_alert_2025.pdf": ("Directorate General of Mines Safety", "https://dgms.gov.in/", "https://www.dgms.gov.in/writereaddata/UploadFile/SaftyAlert34_04122025.pdf", "2025-08-03"),
    "dgms_sanket_noncoal_2016_2022.pdf": ("Directorate General of Mines Safety", "https://dgms.gov.in/", "https://dgms.gov.in/writereaddata/UploadFile/SANKETNonCoal_17042025.pdf", "2016-2022"),
    "peso_annual_report_2008_09.pdf": ("Petroleum and Explosives Safety Organisation", "https://www.peso.gov.in/", "https://www.peso.gov.in/web/sites/default/files/2019-12/AR20082009.pdf", "2008-09"),
    "peso_annual_report_2014_15.pdf": ("Petroleum and Explosives Safety Organisation", "https://www.peso.gov.in/", "https://peso.gov.in/sites/default/files/2019-12/AR_2014_15.pdf", "2014-15"),
    "oil_india_event_reports.json": ("Project-generated", "", "", "2026-09-12"),
...
def build_source_catalogs() -> None:
    ...
    write_csv(ROOT / "01_OIL_INDIA_PUBLIC" / "oil_india_public_source_catalog.csv", [
        ...
        {"source_id":"OIL-EVENTS","title":"Public OIL incident reports and supporting records","publisher":"Oil India Limited plus public authorities","official_url":"https://www.oil-india.com/investor-services/74","years":"1994-2026","local_path":"01_OIL_INDIA_PUBLIC/ACTUAL_EVENT_REPORTS","contains_incident_narratives":"yes","contains_statistics":"limited","priority":"1","notes":"35 deduplicated public OIL/OIL-subsidiary event records with 44 linked source documents; seven source documents are locally downloaded. Includes first-party, regulator, government, court and explicitly marked media-only records; not a complete internal corpus."},
...
def write_docs(stats_count:int, profile_count:int, osha_total:int, osha_selected:int, master_records:int, narrative_records:int, bsee_records:int, dups:dict) -> None:
    ...
    reg(dataset_id="OIL-EVENT-REPORTS", dataset_name="OIL India publicly documented event reports and supporting records", publisher="Oil India Limited plus public authorities", source_type="company/regulator/government/court/media event records", country_or_scope="India", industry="oil and gas", years_covered="1994-2026", official_landing_page="https://www.oil-india.com/investor-services/74", local_raw_path="01_OIL_INDIA_PUBLIC", file_format="PDF/HTML/JSON", file_count="44 linked sources plus JSON", approx_records="35 unique events", has_narrative="yes", has_outcome="yes", has_severity="yes", has_activity="yes", has_location="yes", has_causal_factors="limited", has_barrier_information="yes", has_corrective_actions="yes", recommended_use="REFERENCE_ONLY", training_allowed="no", validation_candidate="no", reference_only="yes", license_or_terms="publisher terms", quality_rating="4", priority="1", comments="35 deduplicated public OIL/OIL-subsidiary event records with 44 linked source documents; seven are locally downloaded. The target of 100 unique records was not reached; aggregate tables, duplicate coverage, non-OIL operators and unverified leads are excluded. Provenance is in oil_india_event_reports.json.")
